...
def vit_calibration_reader(data_dir, batch_size=16):
...
def main():
    ...
    input_model_path = "models/pretrained_vit.onnx"

    # `output_model_path` is the path where the quantized model will be saved.
    output_model_path = "models/vit.qdq.U8S8.onnx"
    ...
    dr = vit_calibration_reader(calibration_dataset_path)
    print(dr)
